                                    ...
                                    >
                                        <Popup className="premium-popup">
                                            <div className="p-2 min-w-[220px]">
                                                ...
                                                <p className="text-[10px] text-gray-500 mb-4 line-clamp-2">{post.content}</p>
                                                <button className="w-full bg-black text-white py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[1px] hover:bg-primary hover:text-black transition-all">
                                                    Lihat Detail
                                                </button>
                                            </div>
                                        </Popup>
