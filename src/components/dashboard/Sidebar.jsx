...
import { 
  ...
  FaShoppingBag, FaReceipt, FaTruck, FaGift
} from "react-icons/fa";
...
export default function DashboardSidebar() {
  ...
  const adminItems = [
    ...
    { label: "Kelola Market", icon: FaShoppingBag, href: "/dashboard/admin/marketplace" },
    { label: "Kelola Rewards", icon: FaGift, href: "/dashboard/admin/rewards" },
  ...
  return (
    <>
      ...
      <div 
        className={`fixed md:relative z-40 inset-y-0 left-0 transition-all duration-300 ease-in-out bg-background border-r border-gray-200 dark:border-gray-800 flex flex-col h-screen overflow-hidden
      ...
      >
        ...
        {/* Nav Scrollable */}
        <nav className="flex-grow overflow-y-auto px-6 space-y-1 custom-scrollbar">
          {navItems.map((item) => {
        ...
        {/* Footer Fixed */}
        <div className="p-6 border-t border-gray-200 dark:border-gray-800 space-y-4 shrink-0">
          {user && (
